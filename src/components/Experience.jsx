    ...
    <section id="experience">
      ...
      <div className="space-y-6">
        {EXPERIENCES.map((experience, i) => (
          <motion.div
            key={i}
            className="shadow-lg rounded-xl p-4 capitalize text-xs md:text-sm group"
          ...
          >
            <div className="flex justify-between mb-2">
              <div className="grid md:grid-cols-[60px_auto]">
                ...
                <h3 className="text-lg font-medium text-teal-500 dark:text-teal-400 dark:group-hover:text-slate-200 tracking-wider">
                  {experience.title}
                </h3>
              ...
              <p className="text-slate-400 dark:text-emerald-400 dark:group-hover:text-slate-200 tracking-wider">
                {experience.time}
              </p>
            </div>
